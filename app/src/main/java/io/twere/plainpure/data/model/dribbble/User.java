...
public class User implements Serializable {
  ...
  @SerializedName("links") private Map<String, String> links;

  @SerializedName("buckets_count") private long bucketsCount;

  @SerializedName("comments_received_count") private long commentsReceivedCount;

  @SerializedName("followers_count") private long followersCount;

  @SerializedName("followings_count") private long followingCount;

  @SerializedName("likes_count") private long likesCount;

  @SerializedName("likes_received_count") private long likesReceivedCount;

  @SerializedName("projects_count") private long projectsCount;

  @SerializedName("rebounds_received_count") private long reboundsReceivedCount;

  @SerializedName("shots_count") private long shotsCount;

  @SerializedName("teams_count") private long teamsCount;

  @SerializedName("can_upload_shot") private boolean canUploadShot;

  @SerializedName("type") private String type;

  @SerializedName("pro") private boolean pro;
  ...
  @SerializedName("shots_url") private String shotsUrl;
